...
export const fetchMultiLabelStores = (id, cityName) => async dispatch => {
  ...
  try {
    console.log(`${BASEURL}/fashion_weeks_multilabel_stores_api.php?id=${id}${cityName ? `&city=${cityName}` : ''}`)
